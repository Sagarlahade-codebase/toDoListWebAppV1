...
public class TodoController extends HttpServlet {
	...
	private void listTodo(HttpServletRequest request, HttpServletResponse response)
		...
		TreeSet<Todo> listTodo = todoDAO.selectAllTodos();
	...
	private void insertTodo(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
		...
		Todo newTodo = new Todo(title, username, description, targetDate, isDone,priority);
	...
	private void updateTodo(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
		...
		boolean isDone = Boolean.valueOf(request.getParameter("isDone"));
		Todo updateTodo = new Todo(id, title, username, description, targetDate, isDone,priority);
